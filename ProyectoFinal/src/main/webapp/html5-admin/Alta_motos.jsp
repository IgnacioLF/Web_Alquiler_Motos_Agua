...
<head>
	<meta charset="utf-8">
	<title>Panel de administrador - Alta moto</title>
				...
				<div class="column ">
					<div class="card">
						...
						<div class="card-block">
							<form action="operaciones.jsp?tipo=alta_moto" method="post">
								<fieldset>
									<label for="nameField">Matricula</label>
									<input type="text" placeholder="123456X" id="matricula" name="matricula" maxlength="7">
									<label for="nameField">Marca</label>
									<input type="text" placeholder="Searaider" id="marca" name="marca" maxlength="10">
